    ...
    <div className='bgImg'>
      <div className='bgT min-h-screen h-full'>
        <div className='text-center'>
          ...
          <div className='flex justify-center'>
            <div className='w-8/12'>
              ...
              <div className='mt-10'>
                <a className='underline text-white font-serif text-2xl' target="_blank" rel="noreferrer" href='https://www.carnegie.no'>Link to Carnegie's Website</a>
              </div>
              <div>
                <a className='underline text-white font-serif text-2xl' target="_blank" rel="noreferrer" href='https://career.carnegie.no/jobs/3660564-it-medarbeider'>Link to Carnegie's Job Listing</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='flex justify-center pb-10'>
          <button onClick={changePageBack} className='bg-yellow-200 mx-5 p-5 w-80 rounded-2xl mt-10 font-serif'>Go Back Home</button>
          <button onClick={changePageForward} className='bg-yellow-200 mx-5 p-5 w-80 rounded-2xl mt-10 font-serif'>Check out the second job listing</button>
        </div>
      </div>
    </div>
  )
